          ...
          <div className="px-5 py-4 border-b border-gray-100/80 flex justify-between items-center">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors duration-200 hover:scale-105 disabled:opacity-50"
              >
          ...
          <div className="max-h-96 overflow-y-auto">
            {isLoading && (
              <div className="py-8 text-center">
                <FiLoader className="w-6 h-6 mx-auto animate-spin text-gray-400" />
              </div>
            )}
