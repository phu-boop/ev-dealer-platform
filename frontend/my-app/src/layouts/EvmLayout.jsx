...
//           <div
//             className={`px-6 py-5 border-b border-blue-700/50 transition-all duration-300 ${
...
//               {/* Dropdown Menu */}
//               {isProfileDropdownOpen && (
//                 <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200/60 py-3 z-40 animate-in fade-in-0 zoom-in-95">
        ...
        <header className="h-20 mx-6 my-3 rounded-3xl bg-white/80 backdrop-blur-lg shadow-sm border-b border-gray-200/60 px-6 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" ref={notificationDropdownRef}>
              ...
              {/* Notification Dropdown */}
              {isNotificationDropdownOpen && (
                <div className="absolute right-0 mt-3 w-96 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200/60 z-40">
                  {/* Header */}
                  <div className="px-4 py-3 border-b border-gray-100/60 flex justify-between items-center">
                    <h3 className="text-lg font-semibold text-gray-800">Thông báo</h3>
                    {unreadCount > 0 && (
            ...
            <div className="relative" ref={profileDropdownRef}>
              ...
              {/* Dropdown Menu */}
              {isProfileDropdownOpen && (
                <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200/60 py-3 z-40">
                  <div className="px-4 py-3 border-b border-gray-100/60">
                    <p className="text-sm font-semibold text-gray-800">
                      Đăng nhập với tư cách
                    </p>
