...
import { calculateDailyOrders, calculateWeeklyOrders, calculateMonthlyOrders } from "../utils/orderChartData";

/**
 * Orders Chart Component
 * Biểu đồ hiển thị số lượng đơn hàng theo thời gian
 */
    ...
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Số Lượng Đơn Hàng Theo Thời Gian</h3>
        </div>
