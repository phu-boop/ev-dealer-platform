    ...
    if (isStaff) {
      ...
      if (currentStaff) {
        ...
        if (currentStaff.staffId === complaint.assignedStaffId) {
          console.log('✅ Match by email -> staffId!');
          return true;
        }
      }
      ...
      switch (selectedStatus) {
        case 'IN_PROGRESS':
          ...
          if (!complaint.assignedStaffId) {
            toast.warning('Vui lòng gán nhân viên trước khi chuyển sang "Đang xử lý"');
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200/80 p-6">
              ...
              <div className="flex items-center gap-2 mb-4 pb-4 border-b flex-wrap">
                ...
                <span className="text-sm font-semibold text-gray-700 ml-2">Mức độ</span>
                <span className={`inline-flex items-center px-4 py-2 text-sm font-bold rounded-full ${
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">Nội dung phản hồi</h3>
                ...
                {progressUpdates && progressUpdates.length > 0 ? (
                  ...
                  <div className="bg-white rounded-xl p-6 text-center">
                    ...
                    <p className="text-gray-400 text-xs mt-1">
                      Sử dụng "Liên hệ khách hàng" hoặc "Thêm ghi chú" để cập nhật tiến độ
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-6">
            ...
            {/* Assignment Info */}
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200/80 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Phân công xử lý</h3>
                ...
                <div className="space-y-3">
                  ...
                  {complaint.firstResponseAt && (
                    <div className="flex items-center text-gray-700">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">Phản hồi lần đầu</p>
                ...
                {!canPerformAction() ? (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-xs text-yellow-700 mt-1">
                      Chỉ nhân viên được phân công hoặc Manager mới có thể thực hiện thao tác
                    </p>
                  </div>
                ) : (
                <div className="space-y-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            ...
            <div className="mb-6">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                💡 Ví dụ: "Đã kiểm tra xe, phát hiện lỗi động cơ. Đang liên hệ kỹ thuật viên."
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                <p className="text-sm text-blue-800">
                  <strong>Lưu ý:</strong> Thay đổi trạng thái sẽ được ghi lại trong tiến trình xử lý
                </p>
              </div>
            </div>
