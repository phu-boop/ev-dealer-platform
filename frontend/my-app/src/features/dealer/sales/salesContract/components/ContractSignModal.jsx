...
// import { Modal, Form, Input, Button, Card, Alert, Divider } from 'antd';
// import { SignatureOutlined, LockOutlined } from '@ant-design/icons';
...
//           Ký hợp đồng số {contract?.contractNumber}
//         </div>
//       }
//       open={visible}
...
//         description="Sau khi ký, hợp đồng sẽ có hiệu lực pháp lý và không thể thay đổi."
//         type="warning"
//         showIcon
...
//           <p><strong>Ngày lập:</strong> {contract && new Date(contract.contractDate).toLocaleDateString('vi-VN')}</p>
//         </div>
//       </Card>
...
//           label="Chữ ký số"
//           rules={[
//             { required: true, message: 'Vui lòng nhập chữ ký số' },
//             { min: 6, message: 'Chữ ký số phải có ít nhất 6 ký tự' }
//           ]}
//         >
//           <Input.Password
...
//         <p>Bằng việc nhấn "Ký hợp đồng", bạn xác nhận đã đọc và đồng ý với tất cả điều khoản trong hợp đồng này.</p>
//       </div>
//     </Modal>
//   );
// };
