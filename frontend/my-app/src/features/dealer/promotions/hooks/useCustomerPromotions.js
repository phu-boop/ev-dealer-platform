...
export const useCustomerPromotions = () => {
  ...
  const loadAllData = useCallback(async () => {
    ...
    try {
      ...
      console.log('Loaded promotions:', promotionsRes.data);
      console.log('Loaded dealers:', dealersRes.data);
  ...
  const getDealersByIds = useCallback((dealerIdsJson) => {
    if (!dealerIdsJson || dealerIdsJson === 'null' || dealerIdsJson === '[]') {
      return [];
    }
    try {
  ...
  const getModelsByIds = useCallback((modelIdsJson) => {
