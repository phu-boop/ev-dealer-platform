...
import { formatCurrency } from "../../../dashboard/utils/calculations";

/**
 * Personal Top Customers Chart Component
 * Hiển thị top khách hàng của staff theo doanh thu
 */
const PersonalTopCustomersChart = ({ orders = [] }) => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Top Khách Hàng Của Tôi</h3>
        </div>
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-semibold text-gray-800">Top 5 Khách Hàng Của Tôi</h3>
      </div>
...
export default PersonalTopCustomersChart;
