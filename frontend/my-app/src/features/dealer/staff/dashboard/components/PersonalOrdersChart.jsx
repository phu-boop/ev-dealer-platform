...
/**
 * Personal Orders Chart Component
 * Biểu đồ hiển thị số lượng đơn hàng cá nhân theo thời gian
 */
const PersonalOrdersChart = ({ orders = [] }) => {
  ...
  const totalDelivered = chartData.reduce((sum, d) => sum + d.delivered, 0);
    ...
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Đơn Hàng Của Tôi Theo Thời Gian</h3>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-600">{totalDelivered}</p>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <svg width={chartWidth} height={chartHeight} className="w-full">
                ...
                return (
                  <g key={index}>
                    ...
                    <rect
                      ...
                      width={barWidth}
                      height={barHeight}
                      fill="url(#barGradientPersonalOrders)"
                      rx="4"
                    />
                    {/* Value label */}
                    <text
              ...
              {/* Gradient definition */}
              <defs>
                <linearGradient id="barGradientPersonalOrders" x1="0%" y1="0%" x2="0%" y2="100%">
...
export default PersonalOrdersChart;
