...
import { countOrdersByStatus } from "../../../dashboard/utils/calculations";

/**
 * Personal Order Status Chart Component
 * Biểu đồ tròn hiển thị phân bố đơn hàng cá nhân theo trạng thái
 */
const PersonalOrderStatusChart = ({ orders = [] }) => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-lg font-semibold text-gray-800">Phân Bố Đơn Hàng Của Tôi</h3>
        </div>
...
export default PersonalOrderStatusChart;
