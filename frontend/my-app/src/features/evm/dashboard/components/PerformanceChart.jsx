 ...
 * Biểu đồ hiệu suất làm việc (số đơn xử lý/ngày)
 */
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-semibold text-gray-800">Biểu Đồ Hiệu Suất Làm Việc</h3>
      </div>
          ...
          <div className="overflow-x-auto">
            <svg width={chartWidth} height={chartHeight} className="w-full">
              ...
              {areaPath && (
                <path
                  d={areaPath}
                  fill="url(#areaGradientPerformance)"
                  opacity="0.3"
                />
              )}
              ...
              <defs>
                <linearGradient id="areaGradientPerformance" x1="0%" y1="0%" x2="0%" y2="100%">
