            ...
            <div className="p-6 flex-1 overflow-y-auto space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm font-semibold text-gray-900">#{selectedTransaction.dealerTransactionId?.substring(0, 8)}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-xs text-gray-500 mb-1">Mã hóa đơn</p>
                  <p className="text-sm font-semibold text-gray-900">#{selectedTransaction.dealerInvoiceId?.substring(0, 8)}</p>
                </div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
              ...
              {selectedTransaction.notes && (
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="text-xs text-blue-600 mb-1 font-medium">Ghi chú từ đại lý</p>
