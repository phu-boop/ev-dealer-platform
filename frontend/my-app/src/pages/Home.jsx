...
const Home = () => {
    ...
    const mockVehicles = [
      {
        ...
        description: "EVM X5 là mẫu SUV điện cao cấp với thiết kế hiện đại, công nghệ tiên tiến và hiệu suất vượt trội. Xe trang bị hệ thống pin 75 kWh cho phép di chuyển lên đến 450km sau mỗi lần sạc."
      },
      {
        id: 2,
        name: "EVM S3",
        ...
        description: "EVM S3 - Sedan điện thế hệ mới với thiết kế trẻ trung, tiết kiệm năng lượng và giá cả phải chăng. Phù hợp cho gia đình và sử dụng đô thị."
      },
      {
        id: 3,
        name: "EVM T7",
        ...
        price: 1800,
        image: "https://images.unsplash.com/photo-1593941707882-a5bba5331fe2?w=400",
        status: "available",
        range: 550,
        ...
        description: "EVM T7 - Flagship SUV 7 chỗ với không gian rộng rãi, công nghệ hàng đầu và hiệu suất đỉnh cao. Lựa chọn hoàn hảo cho gia đình đa thế hệ."
      }
    ];
  ...
  const handleTestDrive = () => {
    ...
    document.getElementById('test-drive-section')?.scrollIntoView({ behavior: 'smooth' });
  };
